...
<div class="main_div">
     ...
     <div class="container">
        <div class="row">
          ...
          <div class="col-sm-4">
              <div class="card text-center" style="margin-top:76px;background-color:#093028;border-radius:10px;color:white" >
              <form method="POST">  
...
?> 
                    ...
                    <h3>Sender Details</h3>
                        ...
                        <label>Name</label>
                        <input type="text"  name="name1" value="<?php echo $arrdata['Name']; ?>" required placeholder="Enter Sender's Name"/><br><br>
                        <label>Email</label>
                        <input type="text" name="email1" value="<?php echo $arrdata['Email']; ?>" required placeholder="Enter Sender's Email id"/><br><br>
                        <label>Amount</label>
          ...
          <div class="col-sm-4">
              <div class="card text-center" style="margin-top:60px;height:380px;">
                   <div class="card-body">
                   <img src="images/709.png" style="width:250px;height:220px;margin-top:40px;">
          ...
          <div class="col-sm-4">
                <div class="card text-center" style="margin-top:76px;background-color:#093028;border-radius:10px;color:white">
                   ...
                   <h3>Recipient Details</h3>
                        ...
                        <label>Name</label>
                        <input type="text"  name="name2" value="" required placeholder="Enter Recipient Name"/><br><br>
                        <label>Email</label>
                        <input type="text" name="email2" value="" required placeholder="Enter Recipient Email id"/><br><br>
...
if(isset($_POST['submit']))
{
    ...
    if($arrdata['Amount'] >= $Sender)
    {
      ...
      $increase_receiver=$receiver_arr['Amount'] + $Sender;
       $query="UPDATE `customer` SET `ID`=$ids,`Amount`= $decrease_sender  where `ID`=$ids ";
       $rec_query="UPDATE`customer` SET `ID`=$id_receiver,`Amount`= $increase_receiver where  `ID`=$id_receiver ";
