...
<div class="main_div">
     ...
     <div class="navbar navbar-expand-md">
      ...
      <a href="#" class="navbar-brand font-weight-bold text-white text-center"><h2>APNA BANK</h2></a>
     ...
     <div class="container">
        <div class="row">
          ...
          <div class="col-sm-6">
            <h1 class="main_text">APNA BANK</h1>
            <p class="big-text">THE SPARKS FOUNDATION</p>
          </div>

          <div class="col-sm-6">
            
            <img src="images/128.png" class="img-fluid" width="600" height="500" style="margin-top:20px;">
